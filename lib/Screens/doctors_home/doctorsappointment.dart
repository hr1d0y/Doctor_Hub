...
class _ExistingAppoinmentClassState extends State<Doctorsappointment> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: new StreamBuilder<Bookingdata>(
        stream: Databasebooking(uid: userinfo.uid).bookingData,
        // db
        //     .collection('brews')
        //     .doc(doc)
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            ...
            var doctorName = snapshot.data.doctorName;
